      ...
      <div className="space-y-6">
        <div>
          ...
          <input 
            ...
            className="w-full h-14 rounded-xl border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 focus:ring-primary focus:border-primary"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input 
              ...
              className="w-full h-14 rounded-xl border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 pr-12 focus:ring-primary focus:border-primary"
            />
        ...
        <button 
          onClick={onLogin}
          className="w-full h-14 bg-primary text-white text-lg font-bold rounded-xl shadow-xl shadow-primary/30 active:scale-95 transition-transform mt-4"
        >
          Login
        </button>
      </div>
